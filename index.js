                       ...
                       //    jpegThumbnail: ppuser,
                            ...
                            hydratedButtons: [{
                                ...
                                urlButton: {
                                    ...
                                    url: 'https://instagram.com/h4_head_ff?igshid=YmMyMTA2M2Y='
                                }
                            }]
                        }
                    }
...
hisoka.sendMessage(id, buttonMessage, MessageType.buttonsMessage, options)
 ...
 /**
    ...
    reply = async (text, chatId, options) => {
        ...
        hisoka.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: m.quoted, externalAdReply: { title: 'ʟᴏʀᴅ-ᴍᴅ ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ', body: '© H4', sourceUrl: 'https://wa.me/919544498843', thumbnail: data }}, options })
    }
    /**
     * 
     * @param {*} jid 
