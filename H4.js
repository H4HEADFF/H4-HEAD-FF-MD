                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://github.com/H4HEADFF/H4-HEAD-FF-MD'
                                }
                            }, {
                                urlButton: {
          ...
          case 'lesbiancheck':
             case 'hornycheck':
                 case 'prettycheck':
                    case 'lovelycheck':
                      case 'uglycheck':
				if (!text) return replay(`Tag Someone, Example : ${prefix + command} @H4`)
					...
					const hehe = H4[Math.floor(Math.random() * lord.length)]
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
          ...
          listType: 1
            ...
            const lordser = fs.readFileSync('./src/H4-HEAD-FF.mp3') 
...
🐦 ${prefix}𝑚𝑢𝑡𝑒 [𝒐𝒏/𝒐𝒇𝒇]
❤️ ${prefix}𝑝𝑟𝑜𝑚𝑜𝑡𝑒 @𝒖𝒔𝒆𝒓
❤️ ${prefix}𝑑𝑒𝑚𝑜𝑡𝑒 @𝒖𝒔𝒆𝒓
❤️ ${prefix}𝑣𝑜𝑡𝑒 [𝒕𝒆𝒙𝒕]
❤️ ${prefix}𝑑𝑒𝑣𝑜𝑡𝑒
❤️ ${prefix}𝑢𝑝𝑣𝑜𝑡𝑒
❤️ ${prefix}𝑐𝑒𝑘𝑣𝑜𝑡𝑒
